...
export const LISTINGS: ListingSeed[] = [
  ...
  { address: "Address available upon request", city: "Oakville", neighbourhood: "Old Oakville", price: 2450000, beds: 5, baths: 4, property_type: "Residential", description: null, image: "/images/33-listing-oakville-heritage.webp", listing_url: null, featured: true },
  { address: "Address available upon request", city: "Oakville", neighbourhood: "River Oaks", price: 989000, beds: 3, baths: 2, property_type: "Residential", description: null, image: "/images/34-listing-oakville-riveroaks.webp", listing_url: null, featured: true },
  { address: "Address available upon request", city: "Burlington", neighbourhood: "Tyandaga", price: 949000, beds: 3, baths: 2, property_type: "Residential", description: null, image: "/images/35-listing-burlington-tyandaga.webp", listing_url: null, featured: true },
  { address: "Address available upon request", city: "Burlington", neighbourhood: "Shoreacres", price: 1725000, beds: 4, baths: 3, property_type: "Residential", description: null, image: "/images/36-listing-burlington-shoreacres.webp", listing_url: null, featured: true },
  { address: "Address available upon request", city: "Burlington", neighbourhood: "Aldershot", price: 815000, beds: 3, baths: 2, property_type: "Residential", description: null, image: "/images/37-listing-burlington-aldershot.webp", listing_url: null, featured: true },
];
